...
func (b *Reader)fill()  {
	//Slice existing data to beginning.
	if b.r > 0{
...
//Avilable returns how many bytes are unused in the buffer
func (b *Writer)Avilable()int  {
...
//Write writes the contents of p ito the buffer.
//It returns the number of bytes written
//if nn < len(p),it also returns an error explaining
//why the write is short
func (b *Writer)Write(p []byte)(nn int,err error)  {
	for len(p) < b.Avilable() && b.err == nil{
		var n int
		if b.Buffered() == 0{
